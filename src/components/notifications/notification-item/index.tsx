...
const NotificationItem = ({
  ...
  return (
    <CardWrapper
      ...
      className={`flex-row items-center space-x-4 rounded-xl ${notification.isRead ? 'bg-transparent dark:bg-blackBeauty' : 'mt-2 bg-primary-200 dark:bg-primary-900'}  px-4 py-6`}
    >
